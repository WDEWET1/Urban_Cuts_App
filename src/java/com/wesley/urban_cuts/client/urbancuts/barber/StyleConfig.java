 ...
 * @author User
 */
public class StyleConfig extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if  (!jTextField1.getText().isEmpty() && 
            ...
            styleValues.put("style_name", jTextField1.getText());
            styleValues.put("description", jTextField2.getText());
            ...
            jLabel6.setText("Save sucessful");
            
        }else{
        
            jLabel6.setForeground(Color.red);
            jLabel6.setText("Please fill in all fields");
        }
